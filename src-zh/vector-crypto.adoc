...
Verification engineers:: These people are responsible for ensuring the correct implementation of the
...
vl and vstart constraints:: Since `vl` and `vstart` refer to elements, Vector Crypto instructions that use elements groups
...
LMUL constraints:: For element-group instructions, `LMUL`*`VLEN` must always be at least as large as `EGW`, otherwise an
...
SEW constraints:: Some Vector Crypto instructions are only defined for a specific `SEW`. In such a case
...
Source/Destination overlap constraints:: Some Vector Crypto instructions have overlap constraints. Encodings that violate these constraints are _reserved_.
...
Application Processors:: Application processors are expected to follow the V-extension and will therefore have `VLEN` ≥ 128.
...
Embedded Processors:: Embedded processors will typically have implementations with `VLEN` < 128. This will require code to be written with
...
Synopsis:: Vector AES final-round decryption
Mnemonic:: vaesdf.vv vd, vs2 +
vaesdf.vs vd, vs2
Encoding (Vector-Vector):: xxx
...
Description:: A final-round AES block cipher decryption is performed.
...
Included in:: <<zvkn>>, <<zvknc>>, <<zvkned>>, <<zvkng>>
...
Synopsis:: Vector AES middle-round decryption
Mnemonic:: vaesdm.vv vd, vs2 +
vaesdm.vs vd, vs2
Encoding (Vector-Vector):: xxx
...
Description:: A middle-round AES block cipher decryption is performed.
...
Synopsis:: Vector AES final-round encryption
Mnemonic:: vaesef.vv vd, vs2 +
vaesef.vs vd, vs2
Encoding (Vector-Vector):: xxx
...
Description:: A final-round encryption function of the AES block cipher is performed.
...
Synopsis:: Vector AES middle-round encryption
Mnemonic:: vaesem.vv vd, vs2 +
vaesem.vs vd, vs2
Encoding (Vector-Vector):: xxx
...
Description:: A middle-round encryption function of the AES block cipher is performed.
...
Synopsis:: Vector AES-128 Forward KeySchedule generation
Mnemonic:: vaeskf1.vi vd, vs2, uimm
Encoding:: xxx
...
Description:: A single round of the forward AES-128 KeySchedule is performed.
...
Synopsis:: Vector AES-256 Forward KeySchedule generation
Mnemonic:: vaeskf2.vi vd, vs2, uimm
Encoding:: xxx
...
Description:: A single round of the forward AES-256 KeySchedule is performed.
...
Synopsis:: Vector AES round zero encryption/decryption
Mnemonic:: vaesz.vs vd, vs2
Encoding (Vector-Scalar):: xxx
...
Description:: A round-0 AES block cipher operation is performed. This operation is used for both encryption and decryption.
...
Synopsis:: Bitwise And-Not
Mnemonic:: vandn.vv vd, vs2, vs1, vm +
...
Description:: A bitwise _and-not_ operation is performed.
...
Included in:: <<zvbb>>, <<zvkb>>, <<zvkn>>, <<zvknc>>, <<Zvkng>>, <<zvks>>
<<Zvksc>>, <<Zvksg>>
...
Synopsis:: Vector Reverse Bits in Elements
Mnemonic:: vbrev.v vd, vs2, vm
Encoding (Vector):: xxx
...
Description:: A bit reversal is performed on the bits of each element.
Operation:: xxx
...
Synopsis:: Vector Reverse Bits in Bytes
Mnemonic:: vbrev8.v vd, vs2, vm
Encoding (Vector):: xxx
...
Description:: A bit reversal is performed on the bits of each byte.
...
Synopsis:: Vector Carry-less Multiply by vector or scalar - returning low half of product.
Mnemonic:: vclmul.vv vd, vs2, vs1, vm +
...
Description:: Produces the low half of 128-bit carry-less product.
...
Synopsis:: Vector Carry-less Multiply by vector or scalar - returning high half of product.
Mnemonic:: vclmulh.vv vd, vs2, vs1, vm +
...
Description:: Produces the high half of 128-bit carry-less product.
...
Synopsis:: Vector Count Leading Zeros
Mnemonic:: vclz.v vd, vs2, vm
Encoding (Vector):: xxx
...
Description:: A leading zero count is performed on each element.
...
Synopsis:: Count the number of bits set in each element
Mnemonic:: vcpop.v vd, vs2, vm
Encoding (Vector):: xxx
...
Description:: A population count is performed on each element.
Operation:: xxx
...
Synopsis:: Vector Count Trailing Zeros
Mnemonic:: vctz.v vd, vs2, vm
Encoding (Vector):: xxx
...
Description:: A trailing zero count is performed on each element.
...
Synopsis:: Vector Add-Multiply over GHASH Galois-Field
Mnemonic:: vghsh.vv vd, vs2, vs1
Encoding:: xxx
...
Description:: A single "iteration" of the GHASH~H~ algorithm is performed.
...
Synopsis:: Vector Multiply over GHASH Galois-Field
Mnemonic:: vgmul.vv vd, vs2
Encoding:: xxx
...
Description:: A GHASH~H~ multiply is performed.
...
Synopsis:: Vector Reverse Bytes
Mnemonic:: vrev8.v vd, vs2, vm
Encoding (Vector):: xxx
...
Synopsis:: Vector rotate left by vector/scalar.
Mnemonic:: vrol.vv vd, vs2, vs1, vm +
...
Description:: A bitwise left rotation is performed on each element of `vs2`
...
Synopsis:: Vector rotate right by vector/scalar/immediate.
Mnemonic:: vror.vv vd, vs2, vs1, vm +
...
Vector-Scalar/Immediate Arguments:: xxx
...
Description:: A bitwise right rotation is performed on each element of `vs2`.
...
Synopsis:: Vector SHA-2 two rounds of compression.
Mnemonic:: vsha2ch.vv vd, vs2, vs1 +
vsha2cl.vv vd, vs2, vs1
Encoding (Vector-Vector) High part:: xxx
...
Encoding (Vector-Vector) Low part:: xxx
...
Included in:: <<zvkn>>, <<zvknc>>, <<zvkng>>, <<zvknh, zvknh[ab]>>
...
Synopsis:: Vector SHA-2 message schedule.
Mnemonic:: vsha2ms.vv vd, vs2, vs1
Encoding (Vector-Vector):: xxx
...
Synopsis:: Vector SM3 Compression
Mnemonic:: vsm3c.vi vd, vs2, uimm
Encoding:: xxx
...
Description:: Two rounds of SM3 compression are performed.
...
Included in:: <<zvks>>, <<zvksc>>, <<zvksg>>, <<zvksh>>
...
Synopsis:: Vector SM3 Message Expansion
Mnemonic:: vsm3me.vv vd, vs2, vs1
Encoding:: xxx
...
Description:: Eight rounds of SM3 message expansion are performed.
...
Synopsis:: Vector SM4 KeyExpansion
Mnemonic:: vsm4k.vi vd, vs2, uimm
Encoding:: xxx
...
Description:: Four rounds of the SM4 Key Expansion are performed.
...
Included in:: <<zvks>>, <<zvksc>>, <<zvksed>>, <<zvksg>>
...
Synopsis:: Vector SM4 Rounds
Mnemonic:: vsm4r.vv vd, vs2 +
vsm4r.vs vd, vs2
Encoding (Vector-Vector):: xxx
...
Description:: Four rounds of SM4 Encryption/Decryption are performed.
...
Synopsis:: Vector widening shift left logical by vector/scalar/immediate.
Mnemonic:: vwsll.vv vd, vs2, vs1, vm +
...
Description:: A widening logical shift left is performed on each element of `vs2`.
