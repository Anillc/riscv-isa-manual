...
NOTE:   _c.sext.w_ is a pseudo-instruction for _c.addiw rd, 0_ (RV64)
...
|CMMV |cm.mvsa01 cm.mva01s s|funct6 3+|r1s' 2+|funct2 3+|r2s' 2+|op
...
NOTE: The SAIL module variable for _rd'/rs1'_ is called _rsdc_.
