...
NOTE: The Logical with Negate instructions can be implemented by inverting the _rs2_ inputs to the base-required AND, OR, and XOR logic instructions.
...
NOTE: The rotate instructions were included to replace a common
...
Mnemonic:: add.uw _rd_, _rs1_, _rs2_
Pseudoinstructions:: zext.w _rd_, _rs1_ &#8594; add.uw _rd_, _rs1_, zero
Encoding:: xxx
...
Description:: This instruction performs an XLEN-wide addition between _rs2_ and the zero-extended least-significant word of _rs1_.
Operation:: xxx
...
Mnemonic:: bclr _rd_, _rs1_, _rs2_
Encoding:: xxx
...
Description:: This instruction returns _rs1_ with a single bit cleared at the index specified in _rs2_.
...
Mnemonic:: bclri _rd_, _rs1_, _shamt_
Encoding (RV32):: xxx
...
Description:: This instruction returns _rs1_ with a single bit cleared at the index specified in _shamt_.
...
Mnemonic:: bext _rd_, _rs1_, _rs2_
Encoding:: xxx
...
Description:: This instruction returns a single bit extracted from _rs1_ at the index specified in _rs2_.
The index is read from the lower log2(XLEN) bits of _rs2_.
Operation:: xxx
...
Mnemonic:: bexti _rd_, _rs1_, _shamt_
Encoding (RV32):: xxx
...
Mnemonic:: binv _rd_, _rs1_, _rs2_
Encoding:: xxx
...
Description:: This instruction returns _rs1_ with a single bit inverted at the index specified in _rs2_.
The index is read from the lower log2(XLEN) bits of _rs2_.
Operation:: xxx
...
Mnemonic:: binvi _rd_, _rs1_, _shamt_
Encoding (RV32):: xxx
...
Description:: This instruction returns _rs1_ with a single bit inverted at the index specified in _shamt_.
The index is read from the lower log2(XLEN) bits of _shamt_.
For RV32, the encodings corresponding to shamt[5]=1 are reserved.
Operation:: xxx
...
Mnemonic:: bset _rd_, _rs1_,_rs2_
Encoding:: xxx
...
Description:: This instruction returns _rs1_ with a single bit set at the index specified in _rs2_.
The index is read from the lower log2(XLEN) bits of _rs2_.
Operation:: xxx
...
Mnemonic:: bseti _rd_, _rs1_,_shamt_
Encoding (RV32):: xxx
...
Description:: This instruction returns _rs1_ with a single bit set at the index specified in _shamt_.
The index is read from the lower log2(XLEN) bits of _shamt_.
For RV32, the encodings corresponding to shamt[5]=1 are reserved.
Operation:: xxx
...
Mnemonic:: clmulr _rd_, _rs1_, _rs2_
Encoding:: xxx
...
Description:: *clmulr* produces bits 2·XLEN−2:XLEN-1 of the 2·XLEN carry-less
product.
Operation:: xxx
...
NOTE: The *clmulr* instruction is used to accelerate CRC calculations.
...
NOTE: This operations is known as population count, popcount, sideways sum, bit summation, or Hamming weight.
...
Description:: This instruction counts the number of 0's before the first 1, starting at the least-significant bit (i.e., 0) and progressing to the most-significant bit (i.e., XLEN-1).
...
NOTE: Calculating the absolute value of a signed integer can be performed
...
Mnemonic:: maxu _rd_, _rs1_, _rs2_
Encoding:: xxx
...
Mnemonic:: minu _rd_, _rs1_, _rs2_
Encoding:: xxx
...
Description:: This instruction sign-extends the least-significant halfword in _rs_ to XLEN by copying the most-significant bit in the halfword (i.e., bit 15) to all of the more-significant bits.
Operation:: xxx
...
Mnemonic:: sh1add _rd_, _rs1_, _rs2_
Encoding:: xxx
...
Description:: This instruction shifts _rs1_ to the left by 1 bit and adds it to _rs2_.
Operation:: xxx
...
Mnemonic:: sh1add.uw _rd_, _rs1_, _rs2_
Encoding:: xxx
...
Description:: This instruction performs an XLEN-wide addition of two addends.
...
Mnemonic:: sh2add _rd_, _rs1_, _rs2_
Encoding:: xxx
...
Description:: This instruction shifts _rs1_ to the left by 2 places and adds it to _rs2_.
Operation:: xxx
...
Mnemonic:: sh2add.uw _rd_, _rs1_, _rs2_
Encoding:: xxx
...
Mnemonic:: sh3add _rd_, _rs1_, _rs2_
Encoding:: xxx
...
Description:: This instruction shifts _rs1_ to the left by 3 places and adds it to _rs2_.
Operation:: xxx
...
Mnemonic:: sh3add.uw _rd_, _rs1_, _rs2_
Encoding:: xxx
...
Description:: This instruction performs an XLEN-wide addition of two addends. The first addend is _rs2_. The second addend is the unsigned value formed by extracting the least-significant word of _rs1_ and shifting it left by 3 places.
Operation:: xxx
...
Mnemonic:: slli.uw _rd_, _rs1_, _shamt_
Encoding:: xxx
...
Description:: This instruction takes the least-significant word of _rs1_, zero-extends it, and shifts it left by the immediate.
Operation:: xxx
...
NOTE: This instruction is the same as *slli* with *zext.w* performed on _rs1_ before shifting.
...
Mnemonic:: xperm.b _rd_, _rs1_, _rs2_
Encoding:: xxx
...
Description:: The xperm.b instruction operates on bytes.
...
Mnemonic:: xperm.n _rd_, _rs1_, _rs2_
Encoding:: xxx
...
Description:: The xperm.n instruction operates on nibbles.
